...
import { ChevronDown, Users, Award, Building2, Clock, CheckCircle2, Hotel, CreditCard, UserCheck, Star, MessageCircle, Calendar, Plane, MapPin, Quote, Phone, Mail, MapPinIcon, Plus } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-4 relative">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300 select-text relative overflow-hidden animate-[fadeUp_0.8s_ease-out_forwards] hover:-translate-y-1">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="text-3xl font-bold text-gray-800">Rp 25 Juta</div>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-600">9 Hari</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Hotel className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Hotel *4</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Plane className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Termasuk Tiket Pesawat</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">±200m dari Masjidil Haram</span>
                    </div>
                  </div>

                  {/* CTA Buttons */}
                  <div className="space-y-3">
                    <button className="w-full group relative px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-500 text-white hover:shadow-[0_0_30px_-5px_rgba(52,211,153,0.5)] transition-all duration-300">
                    ...
                    <button className="w-full group relative px-6 py-3 rounded-xl border-2 border-green-500/20 text-green-600 hover:border-green-500/40 transition-all duration-300">
              ...
              <div className="group bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300 select-text relative overflow-hidden animate-[fadeUp_0.8s_ease-out_0.2s_forwards] hover:-translate-y-1">
                ...
                <div className="relative z-10">
                  {/* Badge */}
                  <div className="inline-block px-4 py-1 rounded-full bg-emerald-100 text-emerald-600 text-sm font-medium mb-6">
                    Umroh Plus
                  </div>
                  ...
                  <div className="mb-6">
                    <div className="text-gray-400 text-sm mb-1">Mulai dari</div>
                    <div className="text-3xl font-bold text-gray-800">Rp 35 Juta</div>
                    <div className="text-gray-400 text-sm">Per Jamaah</div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">12 Hari</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Hotel className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Hotel *5</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Plane className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Termasuk Tiket Pesawat</span>
                    ...
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">±100m dari Masjidil Haram</span>
                    </div>
                  </div>
              ...
              <div className="group bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300 select-text relative overflow-hidden animate-[fadeUp_0.8s_ease-out_0.4s_forwards] hover:-translate-y-1">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    <div className="text-gray-400 text-sm mb-1">Mulai dari</div>
                    <div className="text-3xl font-bold text-gray-800">Rp 150 Juta</div>
                    <div className="text-gray-400 text-sm">Per Jamaah</div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">30 Hari</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Hotel className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Hotel *5</span>
                    ...
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">±50m dari Masjidil Haram</span>
                    </div>
                  </div>
              ...
              <div className="group bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300 select-text relative overflow-hidden animate-[fadeUp_0.8s_ease-out_0.6s_forwards] hover:-translate-y-1">
                <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    <div className="text-gray-400 text-sm mb-1">Mulai dari</div>
                    <div className="text-3xl font-bold text-gray-800">Rp 45 Juta</div>
                    <div className="text-gray-400 text-sm">Per Jamaah</div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">15 Hari</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Hotel className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Hotel *5</span>
                    ...
                    <div className="flex items-center gap-3">
                      <Plane className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Termasuk Tour Turki</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">±100m dari Masjidil Haram</span>
              ...
              {/* Paket 5 - Umroh Plus Dubai */}
              <div className="group bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300 select-text relative overflow-hidden animate-[fadeUp_0.8s_ease-out_0.8s_forwards] hover:-translate-y-1">
                <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    <div className="text-gray-400 text-sm mb-1">Mulai dari</div>
                    <div className="text-3xl font-bold text-gray-800">Rp 40 Juta</div>
                    <div className="text-gray-400 text-sm">Per Jamaah</div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center gap-3">
                      <Plane className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Termasuk Tour Dubai</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">±100m dari Masjidil Haram</span>
              ...
              {/* Paket 6 - Umroh Ramadhan */}
              <div className="group bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300 select-text relative overflow-hidden animate-[fadeUp_0.8s_ease-out_1s_forwards] hover:-translate-y-1">
                <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                
                <div className="relative z-10">
                  {/* Badge */}
                  <div className="inline-block px-4 py-1 rounded-full bg-pink-100 text-pink-600 text-sm font-medium mb-6">
                    Umroh Ramadhan
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center gap-3">
                      <Plane className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">Termasuk Tour Ramadhan</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-green-600" />
                      <span className="text-gray-600">±100m dari Masjidil Haram</span>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-lg transition-all duration-300">
                ...
                <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm mt-1">+62 812-3456-7890</p>
                            <a href="https://wa.me/628123456789" className="inline-flex items-center gap-1 text-sm text-green-600 hover:text-green-700 font-medium mt-1 group">
                              Chat Sekarang 
                  ...
                  <div className="pt-6">
                    <button className="w-full group relative px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-500 text-white hover:shadow-[0_0_30px_-5px_rgba(52,211,153,0.5)] transition-all duration-300">
                      <span className="relative z-10 text-sm font-semibold">Konsultasi Gratis</span>
                      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </button>
                  </div>
                </div>
